...
<body>
    ...
    <script>
        function showMessage(card) {
            card.textContent = "진우야, 생일 진심으로 축하해! 널 만난 건 나에게 축복이야~ 오래오래 행복하고 건강했으면 좋겠고 하루하루 더욱 멋있는 사람이 되었으면 좋겠고 네가 꾸는 꿈들이 다 이루어졌으면 좋겠어. 너의 아픈 모습, 힘든 모습 보기 싫지만 항상 내가 응원하고 네가 그렇게 아파하고 힘들어하지 않게끔 도와줄 테니 나를 믿고 나에게 맡겨. 부디 나쁜 일 조심하고 좋은 길, 꽃길만 걷길 바라! 다시 한번 생일 축하해❤️";
        }
